        ...
        <div className="flex flex-col items-center">
            ...
            <div className="relative mt-10 md:mt-24 md:order-2">
                <div className="absolute -inset-x-1 inset-y-16 md:-inset-x-2 md:-inset-y-6">
                    <div className="w-full h-full max-w-5xl mx-auto rounded-3xl opacity-30 blur-lg filter" style={gradientStyle}></div>
                </div>
                ...
                <div className="relative grid max-w-lg grid-cols-1 gap-6 mx-auto md:max-w-none lg:gap-10 md:grid-cols-3">
                    <div className="flex flex-col overflow-hidden shadow-xl">
                        <div className="flex flex-col justify-between flex-1 p-6 bg-white lg:py-8 lg:px-7">
                            ...
                            <div className="flex items-center mt-8">
                                <div className="ml-4">
                                    <p className="text-base font-bold text-gray-900 font-pj">Chintan Shah</p>
                                    <p className="mt-0.5 text-sm font-pj text-gray-600">Physician, Florida</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col overflow-hidden shadow-xl">
                        <div className="flex flex-col justify-between flex-1 p-6 bg-white lg:py-8 lg:px-7">
                            ...
                            <div className="flex items-center mt-8">
                                <div className="ml-4">
                                    <p className="text-base font-bold text-gray-900 font-pj">Hem Bhatt</p>
                                    <p className="mt-0.5 text-sm font-pj text-gray-600">Doctor, Florida</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col overflow-hidden shadow-xl">
                        <div className="flex flex-col justify-between flex-1 p-6 bg-white lg:py-8 lg:px-7">
                            ...
                            <div className="flex items-center mt-8">
                                <div className="ml-4">
                                    <p className="text-base font-bold text-gray-900 font-pj">Hemang Panchal</p>
                                    <p className="mt-0.5 text-sm font-pj text-gray-600">Cardiologist, Florida</p>
                                </div>
                            </div>
                        </div>
                    </div>
